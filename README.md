...
Fixed for latest C/C++ versions, as well as recent NodeJS versions. 

This repo is used for npm packaging. Dependencies in package.json will have to be updated to point to recent packages. 
